...
class _$FinnishConstructionRecord extends FinnishConstructionRecord {
  ...
  factory _$FinnishConstructionRecord(
      ...
      (new FinnishConstructionRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'FinnishConstructionRecord')
...
class FinnishConstructionRecordBuilder
  ...
  @override
  FinnishConstructionRecord build() => _build();

  _$FinnishConstructionRecord _build() {
    final _$result = _$v ??
