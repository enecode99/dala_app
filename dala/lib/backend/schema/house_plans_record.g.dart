...
class _$HousePlansRecord extends HousePlansRecord {
  ...
  factory _$HousePlansRecord(
      ...
      (new HousePlansRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HousePlansRecord')
...
class HousePlansRecordBuilder
  ...
  @override
  HousePlansRecord build() => _build();

  _$HousePlansRecord _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'HousePlansRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
