...
class _$MortgageRequestRecord extends MortgageRequestRecord {
  ...
  factory _$MortgageRequestRecord(
      ...
      (new MortgageRequestRecordBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MortgageRequestRecord')
...
class MortgageRequestRecordBuilder
  ...
  @override
  MortgageRequestRecord build() => _build();

  _$MortgageRequestRecord _build() {
    final _$result = _$v ??
