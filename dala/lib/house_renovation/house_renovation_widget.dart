                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        child: Builder(
                          builder: (context) {
                            final housePic = widget.house.houseImages.toList();
                            return Container(
                              width: double.infinity,
                              height: 500,
                              child: Stack(
                                          ...
                                          tabs: [
                                            Tab(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'fa58nk7j' /* Kiwango: Chini */,
                                              ),
                                            ),
                                            Tab(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'do8vh3rx' /* Kiwango: Kati */,
                                              ),
                                            ),
                                            Tab(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'f492we0v' /* Kiwango: Juu */,
                                              ),
                                            ),
                                          ],
                                        ),
