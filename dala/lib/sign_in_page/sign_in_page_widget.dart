...
import '../change_pass_page/change_pass_page_widget.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('SIGN_IN_arrow_back_ios_outlined_ICN_ON_T');
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          logFirebaseEvent('Button-ForgotPassword_Navigate-To');
                          await Navigator.push(
                            context,
                            PageTransition(
                              type: PageTransitionType.fade,
                              duration: Duration(milliseconds: 0),
                              reverseDuration: Duration(milliseconds: 0),
                              child: ChangePassPageWidget(),
                            ),
                          );
                        },
                        text: FFLocalizations.of(context).getText(
                          'oiob5kob' /* Umesahau Nywila? */,
                        ),
                        options: FFButtonOptions(
                          width: 170,
                          height: 30,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'SIGN_IN_PAGE_PAGE_JIUNGE_BTN_ON_TAP');
