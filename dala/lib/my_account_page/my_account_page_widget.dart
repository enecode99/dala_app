                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'MY_ACCOUNT_Card_xga8g58j_ON_TAP');
                                      logFirebaseEvent('Card_Alert-Dialog');
                                      await showDialog(
                                        context: context,
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: Text('Fungua Faili'),
                                            content: Text(
                                                'Fungua Faili sasa michakato ya kukujengea nyumba yako ianze.'),
                                            actions: [
                                              TextButton(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'MY_ACCOUNT_Card_64wwz3p7_ON_TAP');
